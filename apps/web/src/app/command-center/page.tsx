...
import { SentinelAIBriefingSection } from "@/components/home/SentinelAIBriefingSection";
...
export const metadata = {
  title: "Command Center | SENTINEL NER",
  description: "National emergency command center, operational decision queue, and live telemetry radar for Northeast India.",
};
...
export default function CommandCenterPage() {
  return (
    <div className="space-y-10 max-w-7xl mx-auto">
      ...
      {/* 3. SENTINEL AI — Autonomous Intelligence Compilation & Interactive Query Station */}
      <SentinelAIBriefingSection />

      {/* 4. Domain Intelligence Hub */}
      <DomainTelemetryHub />
